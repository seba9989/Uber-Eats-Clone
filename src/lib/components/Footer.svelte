<footer>
	<div class="container">
		<div class="logos">
			<img src="/UberLogo.svg" alt="" />

			<div class="stors">
				<a href="https://apps.apple.com/us/app/uber-eats-food-delivery/id1058959277">
					<img
						src="https://d3i4yxtzktqr9n.cloudfront.net/web-eats-v2/c0217c9dde9821a0.svg"
						alt=""
					/>
				</a>
				<a href="https://apps.apple.com/us/app/uber-eats-food-delivery/id1058959277">
		...
		<div class="text">
			<a href="/">Pomoc</a>
			<a href="/">Dodaj swoją restaurację</a>
			<a href="/">Zarejestruj się, aby realizować dostawy</a>
			<a href="/">Utwórz konto firmowe</a>
		</div>
		<div class="text">
			<a href="/">Restauracje w pobliżu</a>
			<a href="/">Pokaż wszystkie miasta</a>
	...
	<div class="footer">
		<div class="icons">
			<a href="/">
				<svg aria-hidden="true" focusable="false" viewBox="0 0 16 16" class="icon">
					<path
			...
			<a href="/">
				<svg aria-hidden="true" focusable="false" viewBox="0 0 14 12" class="icon">
					<path
						fill-rule="evenodd"
						clip-rule="evenodd"
		...
		<div class="links">
			<a href="/">Działanie stron oraz aplikacji Uber i Uber Eats</a>
			<a href="/">Polityka prywatności</a>
			<a href="/">Warunki</a>
			<a href="/">Cennik</a>
			<a href="/">Nie zgadzam się na sprzedaż ani udostępnianie danych osobowych</a>
		</div>
	</div>

	<div class="disclaimer">
		<p>
			Ta strona jest chroniona z użyciem kodu reCAPTCHA. Obowiązują dokumenty: {' '}
			<a href="/">Polityka prywatności</a>
